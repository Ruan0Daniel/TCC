                    ...
                    <div class="col-12">  <!-- bloco de abertura -->
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle"> Informe o número da OS para visualizar as informações </h6> <br>
								...
								<div align="center"> <!-- Formulário de Eventos -->
									<div align="left">
										...
										<?php
											...
											echo"<b>Problemas encontrados:</b> $descricao_problema  <br>";
											echo"<b>Descrição do orçamento:</b> $descricao_orcamento  <br>";
											echo"<b>Valor do Orçamento:</b> $valor_orcamento <br>";			
											echo"<b>Status do Serviço:</b> $status <br>";	
											echo"<b>Valor Final:</b> $valor_final <br>";	
											}
										?>
