                    ...
                    <ul id="sidebarnav">
						...
						<li class="sidebar-item item"> 
							...
							<ul>
								...
								<li> <a href="gerenciar_usuarios.php"> <b> Gerenciar Usuarios </b> </a> </li>
							</ul> 
                    ...
                    <div class="col-5">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item active" aria-current="page">Gerência</li>
                    ...
                    <div class="col-12">  <!-- bloco de abertura -->
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle"> Crie, exclua ou edite os usuários do sistema </h6> <br> 
								...
								<div align="center"> <!-- Formulário de Eventos -->
									<div align="left">
										...
										{ 
											$id2 = isset($_POST['indice']) ? $_POST['indice'] : "";
											
											$query = "select * from usuarios where id ='$id2'";
											$resultado = mysqli_query($conexao, $query);
											...
											<tr> 
												<td> <br><br>
													<form action='cadastrar.php' method='POST'>
														<input type='hidden' name='tipo' value='editar_usuario'> 
														<b> Nome: </b><input type='text' name='nome' value='<?php echo $nome; ?>'>  &nbsp;
														<b>Login: </b><input type='text' name='login' value='<?php echo $login; ?>'> &nbsp;
														<b>Senha: </b><input type='password' name='senha'> &nbsp
														<b>Nivel: </b> <input type='radio' name='nivel' value='1' <?php echo $select1; ?>> Básico &nbsp <input type='radio' name='nivel' value='0' <?php echo $select0; ?>> Completo &nbsp <br> <br>
														<div align='center'> <input type='submit' value='Salvar'> </div>
													</form>
												</td> 
											</tr> 
										</table>
										...
										<table border='1'>
											<tr> 
												<td> <br><br>
													<form action='cadastrar.php' method='POST'>
														<input type='hidden' name='tipo' value='adicionar_usuario'> 
														<b>Nome: </b><input type='text' name='nome'>  &nbsp
														<b>Login: </b><input type='text' name='login'> &nbsp
														<b>Senha: </b><input type='text' name='senha'> &nbsp
														<b>Nivel: </b> <input type='radio' name='nivel' value='1'> Básico &nbsp <input type='radio' name='nivel' value='0'> Completo &nbsp <br> <br>
														<div align='center'> <input type='submit' value='Adicionar'> </div>
													</form>
												</td> 
											</tr> 
										</table>
										...
										<br> <br> <br> <b>Usuários Existentes</b>
										<hr>
											...
											echo"<tr align='center'>";
												...
												echo"<td>";   
													echo"<table>";
														echo"<tr>";
															echo"<td>";
																echo"<form action='gerenciar_usuarios.php' method='POST'>";
																	echo"<input type=hidden name='indice' value='$id'>";
															...
															echo"<td>";
																...
																echo"<input type=hidden name='tipo' value='excluir_usuario'>";
