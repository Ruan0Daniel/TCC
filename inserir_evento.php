                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
						...
						<li class="sidebar-item item">
								...
								<ul>
									<li> <a href="inserir_evento.php"> <b>Inserir Eventos</b> </a> </li>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-5">
                        <h4 class="page-title">Inserir Eventos</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">Eventos</a></li>
									<li class="breadcrumb-item active" aria-current="page">Inserir Eventos</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">  <!-- bloco de abertura -->
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Inserir um Evento</h4>
                                <h6 class="card-subtitle"> Informe o número da OS, data, hora e descrição que deseja inserir no evento!</h6> <br> <br>
									...
									<div align="left">
										...
										<form action="cadastrar.php" method="POST">	
											...
											<table width=100%>
												<tr >
													<td width=25%>
														Ordem de Serviço: <input type=text name=os style="width: 60px;">
													</td>
												</tr>
											</table> <br><br>
											...
											<table width=100%>
												<tr>
													<td width=15%>
														Data: <input type=text name=data style="width: 100px;">
													</td>

													<td>
														Hora: <input type=text name=hora style="width: 65px;">
													</td>
												</tr>
											</table> <br><br>
											...
											<textarea rows=6 cols=50 name=evento></textarea> <br> 
											<br>
