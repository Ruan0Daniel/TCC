                    ...
                    <div class="col-5">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">Ordens de Serviço</a></li>
									<li class="breadcrumb-item active" aria-current="page">OS de Macbook</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
				...
				<form action="cadastrar.php" method="POST">	
					...
					<table width=100%>
						<tr>
							<td>
								Macbook: <input type=radio name=macbook value=Air> Air	<input type=radio name=macbook value=PRO> Pro   		<br><br>
					...
					<table width=100%>
						<tr>
							<td>
								...
								Carregador: <input type=text name=carregador>		<br><br>
								Tamanho da Tela: <input type=text name=tamanho_tela>		<br><br>
					...
					<hr>
					<textarea rows=6 cols=40 name=problema> </textarea> <br> <br> <br>
					...
					<textarea rows=4 cols=40 name=descricao_problema></textarea> <br> <br>
										
					Descrição do orçamento: <br>
					<textarea rows=4 cols=40 name=descricao_orcamento></textarea> <br> <br>
										 
					<b> Valor do Orçamento: </b> <br>
					<b> Status: </b> <br>
