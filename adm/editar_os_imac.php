                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Editar OS de iMac</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <table width=100%>
									...
									<?php
										...
										$consulta = mysqli_query($conexao,"select * from os_imac where os='$os'");
										while($exibir = mysqli_fetch_array($consulta))
										{							
										...
										echo"<form action='cadastrar.php' method='POST'>";	
											...
											echo"<input type=hidden name=equipamento value='imac'>";
											...
											echo"<table width=100%>";
												echo"<tr>";
													echo"<td>";
														...
														echo"Tamanho:  <input type=text name=tamanho value='$tamanho'> <br><br>";
													echo"</td>";

													echo"<td valign='top'>";
														echo"Ano: <input type=text name=ano value='$ano'>	<br><br>";
														echo"Emc: <input type=text name=emc value='$emc'>		<br><br>";		 
													echo"</td>";
												echo"</tr>";
