<?php
include('verificar_login.php'); // Inclusão para verificar se existe um usuário logado válido
include('conexao.php'); // Arquivo PHP com as informações de conexão ao banco de dados
$login = $_SESSION['usuario']; // armazena o login do usuário em uma variável

	$query= "SELECT * FROM usuarios where login='$login'";	// query para fazer uma consult ano banco de dados
	$resultado = mysqli_query($conexao, $query);
	while($exibir = mysqli_fetch_assoc($resultado))
	{
		$nome = $exibir['nome'];	// armazena o nome do usuário em uma variável
		$nivel = $exibir['nivel'];	// armazena o nível de acesso do usuário em uma variável
	}									
?>
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-start me-auto">
                        ...
                        <!-- Search -->
                        <!-- ============================================================== -->
                        <li class="lupa search-box"> 
							<a class="nav-link waves-effect waves-dark" href="javascript:void(0)">
								<!-- <img class="lupa" src='assets\images\lupa.png'> -->
								<i class="ti-search"></i>
							</a>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex">
                                    ...
                                    <div class="ms-auto">
                                        <div class="dl">
											<!-- <form name="organizador" action="painel.php" method="POST"> -->
												<select name='filtro' class="form-select shadow-none" onchange="location.href=this.value" <!-- onchange="this.form.submit() -->">
													<option value="">Filtrar</option>
													<option value="painel.php?filtro=1">Todos</option> </a>
													<option value="painel.php?filtro=2">Abertos</option>
													<option value="painel.php?filtro=3">Aprovados</option>
													<option value="painel.php?filtro=4">Finalizados</option>
												</select>
											<!-- </form> -->
                                        </div>
                                    </div>
									...
									if(isset($_GET["filtro"]))
									{
										...
										switch($option)
										{
														...
														echo"<td>";				
															echo"<td>";
																echo"<form action='visualizar_os.php' method='POST'>";	
																	...
																	echo" <input class='visualizar' type='submit' name='finalizar' value='Visualizar'>";
																echo"</form>";
															echo"</td>";							
														echo"</tr>";	
													echo"</table>";								
																	...
																	<ul class="pagination">
																		<li>			
																			<?php
																				if($pagina_anterior != 0){ ?>
																					<a href="painel.php?filtro=1&pagina=<?php echo $pagina_anterior; ?>" aria-label="Previous">
																		...
																		<?php 
																			...
																			{ 
																				...
																				{ 
																					echo"<li>";
																						echo"<a href=painel.php?filtro=1&pagina=$i>";
																							echo"<b>";
																								echo $i;
																							echo"</b>";
																						echo"</a>";
																		...
																		<li>
																			<?php
																				if($pagina_posterior <= $num_paginas){ ?>
																					<a href="painel.php?filtro=1&pagina=<?php echo $pagina_posterior; ?>" aria-label="Previous">
											...
											case 2:
												...
												$ordens_servico = "SELECT * FROM os where estado='aberto'";
												$resultado_os = mysqli_query($conexao, $ordens_servico);
												...
												$ordens_servico = "SELECT * FROM os where estado='aberto' order by os desc limit $inicio, $quantidade_pagina";
												$resultado_os = mysqli_query($conexao, $ordens_servico);
												while($exibir = mysqli_fetch_assoc($resultado_os))
												{
																...
																echo"<tr>";					
																	...
																	echo"<td>";
																		echo"<form action='cadastrar.php' method='POST'>";	
																			echo'<input type="hidden" name="tipo" value="encaminhar_os">';			
																			echo'<input type="hidden" name="os"';
																			echo"value='$os'>";
																			echo" <input class='encaminhar' type='submit' name='encaminha' value='Orçar'>";
																		echo"</form>";
																	echo"</td>";
																	...
																	echo"<td>";
																		echo"<form action='gerar_pdf.php' method='POST' target='_blank'>";	
																			echo'<input type="hidden" name="pdf" value="termo_entrada">';
																			echo'<input type="hidden" name="os"';
																			echo"value='$os'>";
																			echo'<input type="hidden" name="equipamento"';
																			echo"value='$tipo'>";																
																			echo" <input class='pdf' type='submit' name='excluir' value='PDF'>";
																		echo"</form>";
																	echo"</td>";
																echo"</tr>";	
															echo"</table>";								
																...
																<nav>
																	<ul class="pagination">
																		<li>			
																			<?php
																				if($pagina_anterior != 0){ ?>
																					<a href="painel.php?filtro=2&pagina=<?php echo $pagina_anterior; ?>" aria-label="Previous">
																						<span aria-hidden="true">&laquo;</span>
																					</a>
																			<?php }else{ ?>
																				<span aria-hidden="true">&laquo;</span>
																		...
																		<?php 
																			...
																			{ 
																				...
																				{ 
																					echo"<li>";
																						echo"<a href=painel.php?filtro=2&pagina=$i>";
																							echo"<b>";
																								echo $i;
																							echo"</b>";
																						echo"</a>";
																		...
																		<li>
																			<?php
																				if($pagina_posterior <= $num_paginas){ ?>
																					<a href="painel.php?filtro=2&pagina=<?php echo $pagina_posterior; ?>" aria-label="Previous">
																						<span aria-hidden="true">&raquo;</span>
																					</a>
																				<?php }else{ ?>
																					<span aria-hidden="true">&raquo;</span>
											...
											case 3:
												...
												$ordens_servico = "SELECT * FROM os where estado='aprovado'";
												$resultado_os = mysqli_query($conexao, $ordens_servico);
												...
												$ordens_servico = "SELECT * FROM os where estado='aprovado' order by os desc limit $inicio, $quantidade_pagina";
												$resultado_os = mysqli_query($conexao, $ordens_servico);
												while($exibir = mysqli_fetch_assoc($resultado_os))
												{
																...
																<nav>
																	<ul class="pagination">
																		<li>			
																			<?php
																				if($pagina_anterior != 0){ ?>
																					<a href="painel.php?filtro=3&pagina=<?php echo $pagina_anterior; ?>" aria-label="Previous">
																						<span aria-hidden="true">&laquo;</span>
																					</a>
																			<?php }else{ ?>
																				<span aria-hidden="true">&laquo;</span>
																		...
																		<?php 
																			...
																			{ 
																				...
																				{ 
																					echo"<li>";
																						echo"<a href=painel.php?filtro=3&pagina=$i>";
																							echo"<b>";
																								echo $i;
																							echo"</b>";
																						echo"</a>";
																		...
																		<li>
																			<?php
																				if($pagina_posterior <= $num_paginas){ ?>
																					<a href="painel.php?filtro=3&pagina=<?php echo $pagina_posterior; ?>" aria-label="Previous">
																						<span aria-hidden="true">&raquo;</span>
																					</a>
																				<?php }else{ ?>
																					<span aria-hidden="true">&raquo;</span>
											...
											case 4:
												...
												$ordens_servico = "SELECT * FROM os where estado = 'finalizado' ";
												$resultado_os = mysqli_query($conexao, $ordens_servico);
												...
												$ordens_servico = "SELECT * FROM os where estado = 'finalizado' order by os desc limit $inicio, $quantidade_pagina";
												$resultado_os = mysqli_query($conexao, $ordens_servico);
												while($exibir = mysqli_fetch_assoc($resultado_os))
												{
													echo"<tr align='center'>";
															...
															<nav>
																<ul class="pagination">
																	<li>			
																		<?php
																			if($pagina_anterior != 0){ ?>
																				<a href="painel.php?filtro=4&pagina=<?php echo $pagina_anterior; ?>" aria-label="Previous">
																					<span aria-hidden="true">&laquo;</span>
																				</a>
																		<?php }else{ ?>
																			<span aria-hidden="true">&laquo;</span>
																	...
																	<?php 
																		...
																		{ 
																			...
																			{ 
																				echo"<li>";
																					echo"<a href=painel.php?filtro=4&pagina=$i>";
																						echo"<b>";
																							echo $i;
																						echo"</b>";
																					echo"</a>";
																	...
																	<li>
																		<?php
																			if($pagina_posterior <= $num_paginas){ ?>
																				<a href="painel.php?filtro=4&pagina=<?php echo $pagina_posterior; ?>" aria-label="Previous">
																					<span aria-hidden="true">&raquo;</span>
																				</a>
																			<?php }else{ ?>
																				<span aria-hidden="true">&raquo;</span>
													...
													<nav>
														<ul class="pagination">
															<li>			
																<?php
																	if($pagina_anterior != 0){ ?>
																		<a href="painel.php?pagina=<?php echo $pagina_anterior; ?>" aria-label="Previous">
																			<span aria-hidden="true">&laquo;</span>
																		</a>
																<?php }else{ ?>
																	<span aria-hidden="true">&laquo;</span>
															...
															<?php 
																...
																{ 
																	...
																	{ 
																		echo"<li>";
																			echo"<a href=painel.php?pagina=$i>";
																				echo"<b>";
																					echo $i;
																				echo"</b>";
																			echo"</a>";
															...
															<li>
																<?php
																	if($pagina_posterior <= $num_paginas){ ?>
																		<a href="painel.php?pagina=<?php echo $pagina_posterior; ?>" aria-label="Previous">
																			<span aria-hidden="true">&raquo;</span>
																		</a>
																	<?php }else{ ?>
																		<span aria-hidden="true">&raquo;</span>
