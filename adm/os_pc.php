                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">OS de PC</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">  <!-- bloco de abertura -->
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Inserir uma OS de PC</h4>
								...
								<form action="cadastrar.php" method="POST">	
									...
									<table width=100%>
										<tr>
											<td>
												Equipamento:  <input type=text name=pc> 	<br><br>
												Placa mãe: <input type=text name=placa_mae>		<br><br>
												...
												Fonte: <input type=text name=fonte>		<br><br>
												Gabinete: <input type=text name=gabinete>		<br><br>
									...
									<hr>
									<textarea rows=6 cols=40 name=problema></textarea> <br> <br>
