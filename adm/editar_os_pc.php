                    ...
                    <ul id="sidebarnav">
						...
						<li class="sidebar-item os"> 
							...
							<ul>
								...
								<li> <a href="os_pc.php"> <b>PC</b> </a> </li>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-5">
                        <h4 class="page-title">OS de PC</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">Painel Principal</a></li>
									<li class="breadcrumb-item active" aria-current="page">Editar OS de PC</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <table width=100%>
									<tr>
										<td width=50%>
											<h4 class="card-title">Editar OS de Notebook</h4>
								...
								<?php						
									...
									$consulta = mysqli_query($conexao,"select * from os_pc where os='$os'");
									while($exibir = mysqli_fetch_array($consulta))
									{						
										$pc= $exibir['equipamento'];
									...
									echo"<form action='cadastrar.php' method='POST'>";
										...
										echo"<input type=hidden name=equipamento value='pc'>";
										...
										echo"<table width=100%>";
											echo"<tr>";
												echo"<td>";
													echo"Equipamento:  <input type=text name=pc value='$pc'> 	<br><br>";
													echo"Placa mãe: <input type=text name=placa_mae value='$placa_mae'> 		<br><br>";
													...
													echo"Fonte: <input type=text name=fonte value='$fonte'>		<br><br>";
													echo"Gabinete: <input type=text name=gabinete value='$gabinete'>		<br><br>";
