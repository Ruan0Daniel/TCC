...
<head>
    ...
    <title>Editar OS de Macbook</title>
                    ...
                    <ul id="sidebarnav">
						...
						<li class="sidebar-item os"> 
							...
							<ul>
								...
								<li> <a href="os_macbook.php"> <b>  Macbook </b> </a> </li>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-5">
                        <h4 class="page-title">OS de Macbook</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">Painel Principal</a></li>
									<li class="breadcrumb-item active" aria-current="page">Editar OS de Macbook</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <table width=100%>
									<tr>
										<td width=50%>
											<h4 class="card-title">Editar OS de Macbook</h4>
											<h6 class="card-subtitle"> Altere as informações e clique em salvar </h6> <br> <br>
										</td>
										
										<td width=50% valign=top align=right>
											<div  class="card-title">
												<?php echo"Número da OS: &nbsp <font size='5'>$os</font>";?>
											</div>
										</td>	
									</tr>
								</table>
								...
								<?php	
									...
									$consulta = mysqli_query($conexao,"select * from os where os='$os'");
									...
									echo"<form action='cadastrar.php' method='POST'>";
										...
										echo"<input type=hidden name=equipamento value='macbook'>";
										...
										echo"<table width=100%>";
											echo"<tr>";
												echo"<td>";
													...
													echo"Macbook: <input type=radio name=macbook value=Air $check2>";
													echo"Air <input type=radio name=macbook value=PRO $check1> Pro <br><br>";
													
													echo"Ano: <input type=text name=ano value='$ano'> ";
											echo"</td>";

												echo"<td valign='top'>";
													echo"Modelo:  <input type=text name=modelo value='$modelo'> <br><br>";
													echo"Emc:  <input type=text name=emc value='$emc'> ";
												echo"</td>";	
											echo"</tr>";
										echo"</table> <br> <br>";
					
										echo"<b> Configuração </b> <br>";
										echo"<hr>";

										echo"<table width=100%>";
											echo"<tr>";
												echo"<td>";
													echo"Processador: <input type=text name=processador value='$processador'>	<br><br>";
													echo"Memória Ram: <input type=text name=ram value='$ram'>	<br><br>";
													echo"Placa de Vídeo: <input type=text name=placa_video value='$placa_video'>	<br><br>";
													echo"HD: <input type=text name=hd value='$hd'> <br><br>";
													echo"Carregador: <input type=text name=carregador value='$carregador'> <br><br>";
													echo"Tamanho da Tela: <input type=text name=tamanho_tela value='$tamanho_tela'>		<br><br>";
													echo"Acessórios: <input type=text name=acessorios value='$acessorios'> <br><br><br>";
												echo"</td>";
											echo"</tr>";
										echo"</table>	";				
										...
										echo"<hr>";
										echo"<textarea rows=6 cols=40 name=problema> $problema </textarea> <br> <br> <br>";
										
										echo"<b> Orçamento  </b>";
										echo"<hr>";
										
										echo"Problemas encontrados: <br>";
										echo"<textarea rows=4 cols=40 name=descricao_problema> $descricao_problema </textarea> <br> <br>";
										
										echo"Descrição do orçamento: <br>";
