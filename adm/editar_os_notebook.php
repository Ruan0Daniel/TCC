...
<head>
    ...
    <title>Editar OS de Notebook</title>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
						...
						<li class="sidebar-item os"> 
							...
							<ul>
								<li> <a href="os_notebook.php"> <b> Notebook </b> </a> </li>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-5">
                        <h4 class="page-title">Editar OS de Notebook</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">Painel Principal</a></li>
									<li class="breadcrumb-item active" aria-current="page">Editar OS de Notebook</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
								...
								<?php
									...
									echo"<form action='cadastrar.php' method='POST'>";	
										...
										echo"<input type=hidden name=equipamento value='notebook'>";
										...
										echo"<table width=100%>";
											echo"<tr>";
												echo"<td>";
													echo"Marca:  <input type=text name=marca value='$marca'> <br><br>";												
