        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-5">
                        <h4 class="page-title">OS de Notebook</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">Ordens de Serviço</li>
									<li class="breadcrumb-item active" aria-current="page">OS de Notebook</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <footer class="footer text-center">
                Todos os direitos reservados. Designer e Desenvolvimento. <a
                    href="https://www.nanochip.com.br/">Xtrene</a>.
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
